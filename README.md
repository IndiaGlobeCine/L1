...
<body> 
    ...
    <div id="view-admin-session" class="view-container">
        ...
        <div class="chat-card">
            <div class="chat-header">
                ...
                <span style="font-size:9px; color:var(--neon-cyan); border:1px solid var(--neon-cyan); padding:2px 6px; border-radius:10px;"><i class="fas fa-lock"></i> Encrypted</span>
            </div>
    ...
    <div id="view-client" class="view-container" style="padding: 15px 10px;">
        ...
        <div class="card" style="max-width:100%; width:100%; padding: 12px; flex-shrink:0; margin-bottom:12px;">
            <div style="display:flex; justify-content:space-between; align-items:center; padding-bottom: 10px; border-bottom: 1px dashed rgba(255,255,255,0.1); margin-bottom: 8px;">
                <h3 style="margin:0; border:none; padding:0; font-size:14px;"><i class="fas fa-crosshairs"></i> Live Tracking</h3>
        ...
        <div class="card" style="max-width:100%; width:100%; display:flex; flex-direction:column; flex-shrink:0;">
            ...
            <div id="client-updates-area" class="timeline-feed" style="max-height: 200px;">
        ...
        <div class="chat-card">
            <div class="chat-header">
                ...
                <span style="font-size:9px; color:var(--gold); border:1px solid var(--gold); padding:2px 6px; border-radius:10px;"><i class="fas fa-lock"></i> Encrypted</span>
            </div>
